...
dwEntityList = (0x4DA31BC)
dwForceAttack = (0x31D36E4)
dwForceAttack2 = (0x31D36F0)
dwForceBackward = (0x31D372C)
dwForceForward = (0x31D3738)
dwForceJump = (0x524CFAC)
dwForceLeft = (0x31D3750)
dwForceRight = (0x31D3744)
dwGameDir = (0x627780)
dwGameRulesProxy = (0x52C029C)
dwGetAllClasses = (0xDB201C)
dwGlobalVars = (0x588CF0)
dwGlowObjectManager = (0x52EB640)
dwInput = (0x51F4780)
dwInterfaceLinkList = (0x944E34)
dwLocalPlayer = (0xD8A2CC)
dwMouseEnable = (0xD8FE18)
dwMouseEnablePtr = (0xD8FDE8)
dwPlayerResource = (0x31D1A70)
dwRadarBase = (0x51D7F34)
dwSensitivity = (0xD8FCB4)
dwSensitivityPtr = (0xD8FC88)
dwSetClanTag = (0x8A1B0)
dwViewMatrix = (0x4D94AD4)
dwWeaponTable = (0x51F5240)
dwWeaponTableIndex = (0x325C)
dwYawPtr = (0xD8FA78)
dwZoomSensitivityRatioPtr = (0xD94D18)
dwbSendPackets = (0xD779A)
dwppDirect3DDevice9 = (0xA7050)
m_pStudioHdr = (0x294C)
m_yawClassPtr = (0xD8FA78)
m_pitchClassPtr = (0x51D81D0)
